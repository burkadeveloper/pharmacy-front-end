...
try {
  ...
  QRCode = () => (
    <div className="flex flex-col items-center justify-center p-1 bg-slate-100 rounded border border-slate-200 w-10 h-10">
      <QrCode className="w-4 h-4 text-slate-400" />
      <span className="text-[10px] font-sans text-slate-400 mt-0.5">N/A</span>
    </div>
  );
}
                  ...
                  >
                    ...
                    <td className="px-6 py-4.5">
                      <div className="flex justify-center">
                        {batch.qrCode ? (
                          <div className="p-1.5 bg-white border border-slate-200 rounded-lg shadow-2xs hover:scale-105 transition-transform cursor-zoom-in">
                            <QRCode value={batch.qrCode} size={36} />
                          </div>
                        ) : (
