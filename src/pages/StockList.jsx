                      ...
                      return (
                        <tr key={batch._id} className="hover:bg-gray-50 transition">
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="font-medium text-gray-900">{batch.drugName?.name}</div>
                            {batch.drugName?.brand && <div className="text-sm text-indigo-600">{batch.drugName.brand}</div>}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap font-mono text-sm text-gray-700">{batch.batchNumber}</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{new Date(batch.expiryDate).toLocaleDateString()}</td>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center gap-2">
                              <span className="text-sm font-mono font-bold text-gray-900">{unitLabel}</span>
                              {isLowStockItem && (
                                <span className="bg-rose-100 text-rose-700 text-[10px] font-bold px-2 py-0.5 rounded-full">Low stock</span>
                              )}
                            </div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{batch.shelfLocation || "—"}</td>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`text-xs font-bold px-2 py-1 rounded-full ${statusBadge.classes}`}>
                              {statusBadge.label}
                            </span>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-right">
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gray-900 text-white hover:bg-indigo-600 rounded-lg text-xs font-semibold transition"
                            >
